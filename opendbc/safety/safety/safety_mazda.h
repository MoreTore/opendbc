...
#define MAZDA_2019_STEER_TORQUE   0x24B  // aux bus. DBC: TI_FEEDBACK
...
static safety_config mazda_init(uint16_t param) {
  ...
  static RxCheck mazda_ti_rx_checks[] = {
    ...
    {.msg = {{MAZDA_ENGINE_DATA,  0, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U}, { 0 }, { 0 }}},
    {.msg = {{MAZDA_PEDALS,       0, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 50U}, { 0 }, { 0 }}},
    {.msg = {{TI_STEER_TORQUE,    1, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 50U}, { 0 }, { 0 }}},
  };
  static RxCheck mazda_2019_rx_checks[] = {
    {.msg = {{MAZDA_2019_BRAKE,         0, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 20U}, { 0 }, { 0 }}},
    {.msg = {{MAZDA_2019_GAS,           2, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U}, { 0 }, { 0 }}},
    {.msg = {{MAZDA_2019_CRUISE,        0, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 10U}, { 0 }, { 0 }}},
    {.msg = {{MAZDA_2019_SPEED,         2, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 30U}, { 0 }, { 0 }}},
    {.msg = {{MAZDA_2019_STEER_TORQUE,  1, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 50U}, { 0 }, { 0 }}},
  };
